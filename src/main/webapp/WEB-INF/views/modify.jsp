...
<div class="container">
  <form id="f1" class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="title" value="${vo.pName }" placeholder="프로젝트 이름" name="pName">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        ...
        <input type="text" class="form-control date_form" id="startDate" value="${sd }" placeholder="OOOO-OO-OO" name="sd">
        <span class="glyphicon glyphicon-warning-sign form-control-feedback"></span>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        ...
        <input type="text" class="form-control date_form" id="endDate" value="${ed }" placeholder="OOOO-OO-OO" name="ed">
        <span class="glyphicon glyphicon-warning-sign form-control-feedback"></span>
      </div>
    </div>
      ...
      <label class="control-label col-sm-2" for="pCondition">상태</label>
       <div class="col-sm-10">   
	     <select class="form-control" name="pCondition" id="pCondition">
	     	<option value="">---------</option>
	        <option ${vo.pCondition=="준비"? "selected" :"" } value="준비">준비</option>
	        <option ${vo.pCondition=="진행중"? "selected" :"" } value="진행중">진행중</option>
	        <option ${vo.pCondition=="종료"? "selected" :"" } value="종료">종료</option>
	        <option ${vo.pCondition=="보류"? "selected" :"" } value="보류">보류</option>
	      </select>
	      <span class="glyphicon glyphicon-warning-sign form-control-feedback"></span>
     	 </div>
      </div>
